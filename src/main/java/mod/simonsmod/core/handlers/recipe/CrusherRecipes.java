...
{	
	...
	{
		//addSinteringRecipe(new ItemStack(BlockInit.), new ItemStack(BlockInit.ORE_OVERWORLD), new ItemStack(Blocks.ACACIA_FENCE), 5.0F);
		addSinteringRecipe(new ItemStack(Blocks.ACACIA_FENCE), new ItemStack(Blocks.ACACIA_FENCE_GATE), new ItemStack(BlockInit.BLOCK_ANDESITE), 5.0F);
		addSinteringRecipe(new ItemStack(Blocks.ANVIL, 3), new ItemStack(Blocks.ACACIA_FENCE_GATE), new ItemStack(BlockInit.BLOCK_ANDESITE, 3), 5.0F);
	}
