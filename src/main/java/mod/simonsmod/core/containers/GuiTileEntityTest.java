...
public class GuiTileEntityTest extends GuiContainer
{
	...
	public GuiTileEntityTest(InventoryPlayer player, TileEntityTest tileentity) 
	{
		super(new ContainerTestTileEntity(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityTest.isActive(tileentity))
		{
