...
public class SlotWorkCrafting extends Slot
{
    ...
    /*public SlotWorkCrafting(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
        super(inventoryIn, slotIndex, xPosition, yPosition);
        this.player = player;
        this.craftMatrix = craftingInventory;
    }*/
    public SlotWorkCrafting(EntityPlayer player, IInventory inventory, int index, int x, int y) 
    {
    	super(inventory, index, x, y);
    	this.player = player;
		this.craftMatrix = inventory;
    }
    /*public SlotWorkCrafting(EntityPlayer inventory, TileEntityWorkTable tileentity, int index, int x, int y) {
    	super(inventory, index, x, y);
		this.player = player;
		this.craftMatrix = inventory;
	}
