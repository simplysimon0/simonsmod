...
public class EntityLaserMining extends Entity implements IProjectile {
	...
	public EntityLaserMining(World worldIn) {
		super(worldIn);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public EntityLaserMining(World worldIn, double x, double y, double z) {
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityLaserMining(World worldIn, EntityLivingBase shooter) {
	...
	static {
		CRITICAL = EntityDataManager.createKey(EntityLaserMining.class, DataSerializers.BYTE);
	}
}