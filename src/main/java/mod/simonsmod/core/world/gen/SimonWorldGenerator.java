...
public class SimonWorldGenerator extends WorldGenerator implements IWorldGenerator {
	...
	private void generateOverworld(World world, Random rand, int blockX, int blockZ) {
		if ((int) (Math.random() * 1000) == 1 && MainConfig.genLab) {
			int y = getGroundFromAbove(world, blockX, blockZ);
			BlockPos pos = new BlockPos(blockX, y, blockZ);
			WorldGenerator structure = new LabGneissWorldGen();
