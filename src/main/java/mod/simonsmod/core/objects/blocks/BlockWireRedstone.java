...
public class BlockWireRedstone extends Block
{
    public static final PropertyEnum<BlockWireRedstone.EnumAttachPosition> NORTH = PropertyEnum.<BlockWireRedstone.EnumAttachPosition>create("north", BlockWireRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockWireRedstone.EnumAttachPosition> EAST = PropertyEnum.<BlockWireRedstone.EnumAttachPosition>create("east", BlockWireRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockWireRedstone.EnumAttachPosition> SOUTH = PropertyEnum.<BlockWireRedstone.EnumAttachPosition>create("south", BlockWireRedstone.EnumAttachPosition.class);
    public static final PropertyEnum<BlockWireRedstone.EnumAttachPosition> WEST = PropertyEnum.<BlockWireRedstone.EnumAttachPosition>create("west", BlockWireRedstone.EnumAttachPosition.class);
    ...
    private final List<BlockPos> blocksNeedingUpdate = new ArrayList();

    public BlockWireRedstone(String name) {
		super(Material.IRON, MapColor.STONE);
		setUnlocalizedName(name);
		setRegistryName(name);
		setHardness(0.1F);
		setResistance(10);
		this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockWireRedstone.EnumAttachPosition.NONE).withProperty(EAST, BlockWireRedstone.EnumAttachPosition.NONE).withProperty(SOUTH, BlockWireRedstone.EnumAttachPosition.NONE).withProperty(WEST, BlockWireRedstone.EnumAttachPosition.NONE).withProperty(POWER, false));
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockWireRedstone.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockWireRedstone.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockWireRedstone.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockWireRedstone.EnumAttachPosition.NONE;
    ...
    private BlockWireRedstone.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn, blockpos.down())))
        {
            ...
            if (!iblockstate1.isNormalCube())
            {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up()))
                {
                    ...
                    {
                        return BlockWireRedstone.EnumAttachPosition.UP;
                    }

                    return BlockWireRedstone.EnumAttachPosition.SIDE;
                }
            }

            return BlockWireRedstone.EnumAttachPosition.NONE;
        }
        else
        {
            return BlockWireRedstone.EnumAttachPosition.SIDE;
    ...
    /*private IBlockState calculateCurrentChanges(World worldIn, BlockPos pos1, BlockPos pos2, IBlockState state)
    {
    	...
    	list.add(new BlockPos(pos1.getX() + 1, pos1.getY(), pos1.getZ()));
    	list.add(new BlockPos(pos1.getX() - 1, pos1.getY(), pos1.getZ()));
    	list.add(new BlockPos(pos1.getX(), pos1.getY()+1, pos1.getZ()));
    	list.add(new BlockPos(pos1.getX(), pos1.getY()-1, pos1.getZ()));
    	list.add(new BlockPos(pos1.getX(), pos1.getY(), pos1.getZ()-1));
    	list.add(new BlockPos(pos1.getX(), pos1.getY(), pos1.getZ()+1));
    	for(int i = 0; i < 6; i++)
    	{
    	if(worldIn.getBlockState(pos1).getBlock().canConnectRedstone(state, worldIn, list.get(i), null))
    		this.blocksNeedingUpdate.add(list.get(i));
    	}
    	IBlockState iblockstate = state;
    	if(state == state.withProperty(POWER, true))
    		iblockstate = iblockstate.withProperty(POWER, true);
    ...
    private IBlockState calculateCurrentChanges(World worldIn, BlockPos pos1, BlockPos pos2, IBlockState state)
    {
        IBlockState iblockstate = state;
        int i = 0;
        if(worldIn.getBlockState(pos1).getValue(POWER))
        	i = 16;
        int j = 0;
        ...
        {
        	if(j != 0)
        		state = state.withProperty(POWER, true);
        	else
        		state = state.withProperty(POWER, false);
    ...
    {
    	if(meta == 0)
    		return this.getDefaultState().withProperty(POWER, false);
    	return this.getDefaultState().withProperty(POWER, true);
    }
    ...
    {
    	if(state == this.getDefaultState().withProperty(POWER, false))
        	return 0;
        return 1;
    }
