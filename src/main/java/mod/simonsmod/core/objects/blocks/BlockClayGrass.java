...
public class BlockClayGrass extends Block implements IGrowable, IHasModel {
	public static final PropertyBool SNOWY = PropertyBool.create("snowy");

	public BlockClayGrass(String name) {
	...
	public void registerModels() {
		for (int i = 0; i < EnumLab.values().length; i++) {
			SimonsMod.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i,
					"clay_grass_" + EnumLab.values()[i].getName(), "inventory");
		}
	}
