...
public class BlockHopperDuct extends BlockContainer implements IHasModel {
	...
	public BlockHopperDuct(String name) {
	...
	public void addInformation(ItemStack stack, World world, List<String> info, ITooltipFlag b) {
		if(GuiScreen.isShiftKeyDown())
			info.add("Like a Omni Hopper, but can only hold one item and it cant suck");
		else
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		if (state.equals(BlockInit.HOPPER_DUCT.getDefaultState().withProperty(BlockHopperDuct.FACING, EnumFacing.UP)))
			return UP;
		if (state
				.equals(BlockInit.HOPPER_DUCT.getDefaultState().withProperty(BlockHopperDuct.FACING, EnumFacing.NORTH)))
			return NORTH;
		if (state
				.equals(BlockInit.HOPPER_DUCT.getDefaultState().withProperty(BlockHopperDuct.FACING, EnumFacing.SOUTH)))
			return SOUTH;
		if (state.equals(BlockInit.HOPPER_DUCT.getDefaultState().withProperty(BlockHopperDuct.FACING, EnumFacing.EAST)))
			return EAST;
		if (state.equals(BlockInit.HOPPER_DUCT.getDefaultState().withProperty(BlockHopperDuct.FACING, EnumFacing.WEST)))
			return WEST;
		return DOWN;
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityHopperDuct) {
				((TileEntityHopperDuct) tileentity).setCustomName(stack.getDisplayName());
			}
		}
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			...
			{
				playerIn.openGui(SimonsMod.instance, GuiHandler.HOPPER_DUCT, worldIn, pos.getX(), pos.getY(),
						pos.getZ());
				return true;
			}
		}
