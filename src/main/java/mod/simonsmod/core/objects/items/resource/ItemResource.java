...
public class ItemResource extends Item implements IHasModel {
	...
	public static String[] en_USMetals = new String[]{"Copper","Tin","Silver","Lead","Aluminum","Nickel","Zinc","Platinum","Iridium","Osmium","Tungsten","Cobalt","Titanium","Lithium","Chromium","Bismuth"};
	public static String[] en_USAlloys = new String[]{"Bronze","Steel","Electrum","Invar","Constantan","Brass","ToolSteel","Manyullyn"};
	public static String[] en_USSpecial = new String[]{"Uranium","Plutonium",""};
